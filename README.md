...
- $\begin{bmatrix}\tau_x,& \tau_y,&\tau_z  \end{bmatrix} = \begin{bmatrix}  k_p * p_{err} * I_x,& k_q * q_{err} * I_y,& k_r * r_{err} * I_z\end{bmatrix}$
...
$$
\begin{align}
f_x &= \frac{\tau_x}{l} = F_1 + F_4 - F_2 - F_3 \\
f_y &= \frac{\tau_y}{l} = F_1 + F_2 - F_3 - F_4 \\
f_z &= \frac{\tau_z}{l} = F_1 + F_3 - F_2 - F_4 \\
f_t &= F_1 + F_2 + F_3 + F_4
\end{align}
$$
